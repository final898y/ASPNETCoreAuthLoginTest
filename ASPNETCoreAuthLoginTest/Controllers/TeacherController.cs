...
namespace ASPNETCoreAuthLoginTest.Controllers
{
    ...
    {
        private readonly IUserService<TeacherProfileViewModel> _teacherService;

        public TeacherController(IUserService<TeacherProfileViewModel> teacherService)
        {
        ...
        public IActionResult Profile()
        {
            ...
            var user = _teacherService.GetUserProfile(accountName);
            if (user == null)
            {
                return View("AppError", new AppErrorViewModel
                {
